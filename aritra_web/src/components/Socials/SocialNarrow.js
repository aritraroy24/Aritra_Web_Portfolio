...
import './SocialNarrow.scss'

function SocialNarrow() {
    return (
        <Fade bottom cascade>
            <div className='Socials_Narrow'>
                <div className='Social_Part'>
                    <a
                        href='https://linktr.ee/aritraroy24'
                        target='_blank'
                    ...
                    <a
                        href='https://www.linkedin.com/in/aritraroy24/'
                        target='_blank'
                        rel='noopener noreferrer'>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                ...
                <div className='Social_Part'>
                    ...
                    <a
                        href='https://aritraroy24.netlify.app/'
                        target='_blank'
                        rel='noopener noreferrer'>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            role='img'>
                            <title>Academic Portfolio Website</title>
